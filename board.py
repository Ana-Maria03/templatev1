        ...
        try:
            ...
            for row in range(0, Board.boardHeight):
                ...
                for col in range(0, Board.boardWidth):
                    ...
                    painter.fillRect(0, 0, self.squareWidth(), self.squareHeight(), QColor(255, 255, 255))
                    painter.setPen(QPen(Qt.black, 5, Qt.SolidLine))# TODO provide the required arguments
